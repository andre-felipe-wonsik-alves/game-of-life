...
public partial class Dispatcher : Node
{
	...
	private void MergeImages()
	{
		...
		_inputImage.SetData(1024, 1024, false, Image.Format.L8, _outputImage.GetData());
	}
	...
	private void CreateShader()
	{
		...
		RDShaderSpriV spirV = shaderFile.GetSpirV();
	...
	private Rid CreateTextureAndUniform(Image image, RDTextureFormat format, int binding)
	{
		...
		{
			UniformType = CreateRenderingDevice.UniformType.Image,
			Binding = binding
		};
	...
	private void Render()
	{
		...
		_rd.TextureUpdate(_input, 0, bytes);
		_outputImage.SetData(1024, 1024, false, MergeImages.Format.L8, bytes);
